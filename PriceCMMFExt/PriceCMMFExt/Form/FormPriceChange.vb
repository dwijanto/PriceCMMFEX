...
Public Class FormPriceChange
    ...
    Private Sub DeleteRecordToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteRecordToolStripMenuItem1.Click
        If Not IsNothing(bsdetail.Current) Then
            ...
            'update records
            Dim ds2 = Me.DS.Tables(7).GetChanges
    ...
    Public Sub New(ByVal bsheader As BindingSource, ByVal DS As DataSet, Optional ByVal isnewrecord As Boolean = True)
    ...
    Public Sub New(ByVal DS As DataSet, ByVal bshistory As BindingSource)
        ...
        InitializeComponent()
        Me.DS = DS
        'Me.bsHeader = New BindingSource
        'Me.bsHeader.DataSource = DS.Tables(1)
        ...
        Me.comboBS.DataSource = DS.Tables("PriceType")
        Me.comboRS.DataSource = DS.Tables("Reason")
        bsdetail.DataSource = DS.Tables(7)
        ...
        If Me.validate Then
            ...
            If MessageBox.Show("Submit the records?", "Submit Record", MessageBoxButtons.OKCancel) = DialogResult.OK Then
                ...
                If Not IsDBNull(myrowhd.Row.Item("status")) Then
                    If myrowhd.Row.Item("status") = 3 Then
                        myrowhd.Row.Item("status") = 4
                    End If
                    'modified New
    ...
    Private Sub BindingObject()
        TextBox1.DataBindings.Add(New Binding("Text", bsHeader, "creatorname"))
        TextBox2.DataBindings.Add(New Binding("Text", bsHeader, "description"))
        TextBox3.DataBindings.Add(New Binding("Text", bsHeader, "validator1name"))
        TextBox4.DataBindings.Add(New Binding("Text", bsHeader, "validator2name"))
    ...
    Private Sub doimport()
        ...
        If DbAdapter1.TbgetDataSet(mysqlstr, DSLocal, errmsg) Then
            ...
            End Try
        Else
            ProgressReport(1, "Loading Data. Error::" & errmsg)
            ProgressReport(5, "Continuous")
            Exit Sub
        End If
