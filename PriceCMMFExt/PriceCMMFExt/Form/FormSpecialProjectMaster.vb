...
Public Class FormSpecialProjectMaster
    ...
    Public Sub LoadData()
        ...
        sqlstr = " select * from pricechangespecialproject U order by lineno;"


        If DbAdapter1.TbgetDataSet(sqlstr, DS, mymessage) Then
            DS.Tables(0).TableName = "SpecialProject"
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        Dim myform = New DialogInputSpecialProject(BS)
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.PriceChangeSpecialProject(Me, mye) Then
                DS.Merge(ds2)
                DS.AcceptChanges()
